...
if __name__ == '__main__':
  ...
  filename = 'data/{}.csv'.format(name)  # Which file you're reading from
  outname = 'data/{}-dataset.csv'.format(name)  # Name of the file to write to (erases if already exists)
